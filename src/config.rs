...
fn default_bindings() -> Vec<Binding> {
    ...
    vec![
        ...
        bind(KeyCode(KeyCode::LEFT), SwapWindowLeft, true),
        bind(KeyCode(KeyCode::RIGHT), SwapWindowRight, true),
        ...
        bind(KeyCode(KeyCode::LEFT | KeyCode::SHIFT), FocusLeft, false),
        bind(KeyCode(KeyCode::RIGHT | KeyCode::SHIFT), FocusRight, false),
        bind(KeyCode(KeyCode::UP | KeyCode::META), ResizeUp, true),
        bind(KeyCode(KeyCode::DOWN | KeyCode::META), ResizeDown, true),
        bind(KeyCode(KeyCode::LEFT | KeyCode::META), ResizeLeft, true),
        bind(KeyCode(KeyCode::RIGHT | KeyCode::META), ResizeRight, true),
